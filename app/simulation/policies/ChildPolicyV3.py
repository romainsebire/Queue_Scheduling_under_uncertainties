# Policy for Solution V3 — VIP / Walk-in / Hold with ROI scoring (score ~90.38%)
...
class ChildPolicy(Policy):
    def __init__(self, model_title, seed=42):
        ...
        self.model = None
        self.seed = seed
        self.model_path = os.path.join("app", "data", "models", "ppo_third")
    ...
    def learn(self, scenario, total_timesteps, verbose=1, callback=None, **kwargs):
        print(f"--- [V3] Starting Training for {total_timesteps} steps (seed={self.seed}) ---")
        ...
        print(f"--- [V3] Training Finished. Model saved at {self.model_path}.zip ---")
